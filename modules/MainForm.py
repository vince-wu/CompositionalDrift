...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 391, 612))
        ...
        self.numAvDp_DoubleSpinBox.setEnabled(True)
        self.numAvDp_DoubleSpinBox.setReadOnly(True)
        self.numAvDp_DoubleSpinBox.setMaximum(10000000.0)
        self.numAvDp_DoubleSpinBox.setObjectName("numAvDp_DoubleSpinBox")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.numAvDp_DoubleSpinBox)
        ...
        self.weightAvDp_DoubleSpinBox.setEnabled(True)
        self.weightAvDp_DoubleSpinBox.setReadOnly(True)
        self.weightAvDp_DoubleSpinBox.setMaximum(10000000.0)
        self.weightAvDp_DoubleSpinBox.setObjectName("weightAvDp_DoubleSpinBox")
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.weightAvDp_DoubleSpinBox)
        ...
        self.dispersityDoubleSpinBox.setEnabled(True)
        self.dispersityDoubleSpinBox.setReadOnly(True)
        self.dispersityDoubleSpinBox.setMaximum(10000000.0)
        self.dispersityDoubleSpinBox.setObjectName("dispersityDoubleSpinBox")
        self.formLayout_6.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.dispersityDoubleSpinBox)
        self.line = QtWidgets.QFrame(self.scrollAreaWidgetContents_3)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.formLayout_6.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.line)
        ...
        self.graphComboBox.addItem("")
        self.graphComboBox.addItem("")
        self.formLayout_6.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.graphComboBox)
        ...
        self.formLayout_6.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.runLengthSpinBox)
        self.label_10 = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.label_10.setObjectName("label_10")
        self.formLayout_6.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_10)
        ...
        self.formLayout_6.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.rowsSpinBox)
        self.label_7 = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.label_7.setObjectName("label_7")
        self.formLayout_6.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_7)
        ...
        self.animateComboBox.addItem("")
        self.formLayout_6.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.animateComboBox)
        self.label_8 = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.label_8.setObjectName("label_8")
        self.formLayout_6.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_8)
        ...
        self.legendComboBox.addItem("")
        self.formLayout_6.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.legendComboBox)
        ...
        self.lambdaDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_3)
        self.lambdaDoubleSpinBox.setEnabled(True)
        self.lambdaDoubleSpinBox.setReadOnly(True)
        self.lambdaDoubleSpinBox.setDecimals(3)
        self.lambdaDoubleSpinBox.setMinimum(-2.0)
        self.lambdaDoubleSpinBox.setMaximum(1.0)
        self.lambdaDoubleSpinBox.setObjectName("lambdaDoubleSpinBox")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lambdaDoubleSpinBox)
        ...
        self.stopPushButton = QtWidgets.QPushButton(self.tab_2)
        self.stopPushButton.setObjectName("stopPushButton")
        self.horizontalLayout_2.addWidget(self.stopPushButton)
        self.copyPushButton = QtWidgets.QPushButton(self.tab_2)
        self.copyPushButton.setObjectName("copyPushButton")
        self.horizontalLayout_2.addWidget(self.copyPushButton)
        self.rrLoadButton = QtWidgets.QPushButton(self.tab_2)
        self.rrLoadButton.setObjectName("rrLoadButton")
        self.horizontalLayout_2.addWidget(self.rrLoadButton)
        ...
        self.rr_textBrowser = QtWidgets.QTextBrowser(self.tab_2)
        self.rr_textBrowser.setObjectName("rr_textBrowser")
        self.verticalLayout_7.addWidget(self.rr_textBrowser)
        ...
        self.numSetsSpinBox = QtWidgets.QSpinBox(self.scrollAreaWidgetContents_2)
        self.numSetsSpinBox.setMaximum(1000000000)
        self.numSetsSpinBox.setProperty("value", 3)
        self.numSetsSpinBox.setObjectName("numSetsSpinBox")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.numSetsSpinBox)
        ...
        self.densitySpinBox = QtWidgets.QSpinBox(self.scrollAreaWidgetContents_2)
        self.densitySpinBox.setMaximum(1000000000)
        self.densitySpinBox.setProperty("value", 100)
        self.densitySpinBox.setObjectName("densitySpinBox")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.densitySpinBox)
        ...
        self.rr_animateComboBox = QtWidgets.QComboBox(self.scrollAreaWidgetContents_2)
        self.rr_animateComboBox.setObjectName("rr_animateComboBox")
        self.rr_animateComboBox.addItem("")
        self.rr_animateComboBox.addItem("")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.rr_animateComboBox)
        ...
        self.r1_low_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.r1_low_doubleSpinBox.setDecimals(4)
        self.r1_low_doubleSpinBox.setProperty("value", 0.6)
        self.r1_low_doubleSpinBox.setObjectName("r1_low_doubleSpinBox")
        self.formLayout_10.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.r1_low_doubleSpinBox)
        self.label_22 = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        self.label_22.setObjectName("label_22")
        self.formLayout_10.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_22)
        self.r1_high_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.r1_high_doubleSpinBox.setDecimals(4)
        self.r1_high_doubleSpinBox.setProperty("value", 1.2)
        self.r1_high_doubleSpinBox.setObjectName("r1_high_doubleSpinBox")
        self.formLayout_10.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.r1_high_doubleSpinBox)
        ...
        self.r2_low_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.r2_low_doubleSpinBox.setDecimals(4)
        self.r2_low_doubleSpinBox.setProperty("value", 0.6)
        self.r2_low_doubleSpinBox.setObjectName("r2_low_doubleSpinBox")
        self.formLayout_10.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.r2_low_doubleSpinBox)
        ...
        self.r2_high_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.r2_high_doubleSpinBox.setDecimals(4)
        self.r2_high_doubleSpinBox.setProperty("value", 1.2)
        self.r2_high_doubleSpinBox.setObjectName("r2_high_doubleSpinBox")
        self.formLayout_10.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.r2_high_doubleSpinBox)
        ...
        self.r1_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.r1_doubleSpinBox.setReadOnly(True)
        self.r1_doubleSpinBox.setDecimals(4)
        self.r1_doubleSpinBox.setObjectName("r1_doubleSpinBox")
        self.formLayout_12.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.r1_doubleSpinBox)
        ...
        self.r2_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.r2_doubleSpinBox.setReadOnly(True)
        self.r2_doubleSpinBox.setDecimals(4)
        self.r2_doubleSpinBox.setObjectName("r2_doubleSpinBox")
        self.formLayout_12.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.r2_doubleSpinBox)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 435, 858))
        ...
        self.line_2 = QtWidgets.QFrame(self.scrollAreaWidgetContents_5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_18.setToolTip(_translate("MainWindow", "Describes polymer rigidity. Only valid for 2-monomer systems"))
        self.label_18.setText(_translate("MainWindow", "lambda Value"))
        self.lambdaDoubleSpinBox.setSpecialValueText(_translate("MainWindow", "n/a"))
        ...
        self.copyPushButton.setText(_translate("MainWindow", "Copy Bounds"))
        self.rrLoadButton.setText(_translate("MainWindow", "Load"))
        self.label_11.setText(_translate("MainWindow", "Number of Data Sets"))
        self.label_16.setText(_translate("MainWindow", "Step Density"))
        self.label_17.setText(_translate("MainWindow", "Animate"))
        self.rr_animateComboBox.setItemText(0, _translate("MainWindow", "On"))
        self.rr_animateComboBox.setItemText(1, _translate("MainWindow", "Off"))
        self.label_21.setText(_translate("MainWindow", "RR1 Lower Bound"))
        self.label_22.setText(_translate("MainWindow", "RR1 Upper Bound"))
        self.label_28.setText(_translate("MainWindow", "RR2 Lower Bound"))
        self.label_29.setText(_translate("MainWindow", "RR2 Upper Bound"))
        self.label_19.setText(_translate("MainWindow", "<html><head/><body><p>r<span style=\" vertical-align:sub;\">1 </span>Prediction</p></body></html>"))
        self.label_20.setText(_translate("MainWindow", "<html><head/><body><p>r<span style=\" vertical-align:sub;\">2</span> Prediction</p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Reactivity Ratio"))
